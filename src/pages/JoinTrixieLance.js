      ...
      <div className="pricing container">
        ...
        <div className="main-div-pricing space-x-24">
          <div className="card-pricing">
            <img src={packet1} width="128" height="128" />
            <h5>Monthly</h5>
            <p className="price-per-month">$25/Month</p>
            <Link to="/" className="select-subscription">
              SELECT
            </Link>
          ...
          <div className="card-pricing">
            <img src={packet2} width="128" height="128" />
            <h5>3 Months</h5>
          ...
          <div className="card-pricing">
            <img src={packet3} width="128" height="128" />
            <h5>6 Months</h5>
...
export default JoinTrixieLance;
